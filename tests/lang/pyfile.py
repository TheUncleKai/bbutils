...
class TestPythonFile(unittest.TestCase):
    ...
    def test_create_01(self):
        ...
        self.assertEqual(_pyfile.path, full_path('{0:s}/gui'.format(_locales)))
        self.assertEqual(_pyfile.pot, full_path('{0:s}/gui/_testlang.test1.pot'.format(_locales)))
    ...
    def test_create_04(self):
        ...
        self.assertEqual(_check1, True, "_check != True")
        self.assertEqual(_pyfile.path, full_path('{0:s}/gui'.format(_locales)))
        self.assertEqual(_pyfile.pot, full_path('{0:s}/gui/_testos1.pot'.format(_locales)))
        self.assertEqual(_pyfile.domain, 'gui')
